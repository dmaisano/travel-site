...
var featureItems = new _LazyLoad2.default((0, _jquery2.default)(".feature-item"), "85%");
var testimonial = new _LazyLoad2.default((0, _jquery2.default)(".testimonial"), "70%");
    ...
    value: function createWayPoints() {
      ...
      try {
        var _loop = function _loop() {
          ...
          var offsetPercent = _this.offsetPercent;
        ...
        for (var _iterator = this.items_to_reveal[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          _loop();
        }
      } catch (err) {
...
var StickyHeader = function () {
  ...
  _createClass(StickyHeader, [{
    key: "create_header_waypoint",
    value: function create_header_waypoint() {
      var that = this;
      ...
      new Waypoint({
        ...
        handler: function handler(direction) {
          ...
          if (direction == "down" && (0, _jquery2.default)(window).width() >= 768) {
    ...
    key: "add_smooth_scrolling",
    value: function add_smooth_scrolling() {
      this.headerLinks.smoothScroll();
    }
  }, {
    key: "create_page_section_waypoints",
    value: function create_page_section_waypoints() {
      var that = this;
