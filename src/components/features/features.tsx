...
const Features: React.FC = () => {
  return (
    <div id="features" className="wrapper bg-primary py-16">
      <div id="title" className="w-full mb-8">
        <img
          className="mx-auto mb-2"
          src={`${PUBLIC_URL}/assets/images/icons/star.svg`}
          alt=""
        />
        <h2 className="text-white text-center text-4xl font-light">
      ...
      <div id="feature-items" className="flex flex-wrap">
        <div id="feature-item">
          ...
          <p>
            ...
            about to rain in the next 20 minutes around your current location. A
            good rain can be refreshing, but sometimes you just want to stay
            dry.
          </p>
        </div>
        ...
        <div id="feature-item">
          ...
          <p>
            ...
            the finest materials. The kit will allow you to setup a tent, start
            a fire, scratch your own back and lower your taxes.
          </p>
        </div>
      </div>
    </div>
